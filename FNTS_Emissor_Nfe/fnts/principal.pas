...
uses
  ...
  caixa_operador, senha_caixa, contaspagar, venda, venda_inicio, contasreceber,
  ...
  convenio_receber, empresa, cst, modelo_fiscal, ecfs, sintegra_menu, ecf,
  ...
  fluxo_caixa, DRE, mensagem_inventario, Ncm, xloc_csosn, importa_nfe, sobre, // FMapa,
  form_ativacaoicloud, pUCGeral, OpNatureza, Unit_ativar, PartilhaICMS;
