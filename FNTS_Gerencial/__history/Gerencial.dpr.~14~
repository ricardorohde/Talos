...
uses
  ...
  produto_importaEAN in 'fnts\produto_importaEAN.pas' {frmproduto_importaEAN},
  Vendedor in '..\FNTS_Comuns\Vendedor.pas',
  VendedorConsulta in '..\FNTS_Comuns\VendedorConsulta.pas';
...
begin
  ...
  Application.CreateForm(TfrmSelecionaEmpresa, frmSelecionaEmpresa);
  Application.CreateForm(Tfrmproduto_importaEAN, frmproduto_importaEAN);
  frmsplash.Close;
