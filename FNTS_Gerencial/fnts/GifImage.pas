...
// with the subject "TJvGIFImage HBitmap leak on assign?"                       //
// in borland.public.delphi.graphics on Mon 28 Jul 2003 and Sun 03 Aug 2003.  //
//                                                                            //
// Changed 2004.03.09 by Finn Tolderlund:                                     //
// Added a ForceFrame property to the TJvGIFImage class.                        //
// The ForceFrame property can be used to make TJvGIFImage display a apecific   //
// sub frame from an animated gif.                                            //
// How to use: Set the JvxAnimate property to False and set the ForceFrame       //
// property to a desired frame number (0-N)                                   //
// Normal display: Set the ForceFrame property to -1 and set JvxAnimate to True. //
// If ForceFrame is negative TJvGIFImage behaves just as before this change.    //
...
//
// * Buffered display flickers when TJvGIFImage is used by a transparent TImage
//   component.
...
// { TODO -oanme -cFeature : Make some of TJvGIFImage's properties persistent (DrawOptions etc). }
// { TODO -oanme -cFeature : Add TJvGIFImage.Persistent property. Should save published properties in application extension when this options is set. }
...
(*
  ...
  REGISTER_TGIFIMAGE            Define this symbol to register TJvGIFImage with
...
// Delphi 1.x
{$IFDEF VER80}
  'Error: TJvGIFImage does not support Delphi 1.x'
{$ENDIF}
...
type
  // TJvGIFImage mostly throws exceptions of type GIFException
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public
    ...
    property Image: TJvGIFImage read FGIFImage;
  end;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  protected
    ...
    procedure Warning(Severity: TGIFSeverity; Message: string); virtual;
  public
    constructor Create(Image: TJvGIFImage);
    destructor Destroy; override;
    ...
    property Image: TJvGIFImage read FImage;
  end;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public
    constructor Create(GIFImage: TJvGIFImage); override;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  private
    FImage		: TJvGIFImage;	// The TJvGIFImage that owns this painter
...
{$endif}
  ...
  public
    constructor Create(AImage: TJvGIFImage; ACanvas: TCanvas; ARect: TRect;
      Options: TGIFDrawOptions);
    constructor CreateRef(Painter: PGIFPainter; AImage: TJvGIFImage; ACanvas: TCanvas; ARect: TRect;
      Options: TGIFDrawOptions);
    destructor Destroy; override;
    procedure Start;
    procedure Stop;
...
{$ENDIF}
  public
    ...
    property AnimationSpeed: integer read FAnimationSpeed write SetAnimationSpeed;
    property JvxAnimate: Boolean read GetAnimate write SetAnimate;  // 2002.07.07
...
////////////////////////////////////////////////////////////////////////////////
var
  //: Default options for TJvGIFImage.DrawOptions.
...
{$ENDIF}
  ...
  // This will not affect TJvGIFImage.SaveToStream or SaveToFile.
...
// Since TJvGIFImage isn't a component there's nothing to register here, but
// since Register is only called at design time we can set the design time
// GIF paint options here (modify as you please):
procedure Register;
begin
  // Don't loop animations at design-time. Animated GIFs will JvxAnimate once and
...
//
////////////////////////////////////////////////////////////////////////////////
constructor TGIFItem.Create(GIFImage: TJvGIFImage);
begin
  inherited Create;
...
//
////////////////////////////////////////////////////////////////////////////////
constructor TGIFList.Create(Image: TJvGIFImage);
begin
  inherited Create;
  FImage := Image;
  FItems := TList.Create;
...
//
////////////////////////////////////////////////////////////////////////////////
constructor TGIFHeader.Create(GIFImage: TJvGIFImage);
begin
...
begin
  ASSERT(longInt($FFFFFFFF) = -1, 'TJvGIFImage implementation assumes $FFFFFFFF = -1');
...
constructor TGIFSubImage.Create(GIFImage: TJvGIFImage);
begin
  inherited Create(GIFImage);
...
begin
  ...
  begin
    ...
    begin
      SubImage := TGIFSubImage.Create(Parent as TJvGIFImage);
      try
...
//
////////////////////////////////////////////////////////////////////////////////
constructor TGIFPainter.CreateRef(Painter: PGIFPainter; AImage: TJvGIFImage;
...
constructor TGIFPainter.Create(AImage: TJvGIFImage; ACanvas: TCanvas; ARect: TRect;
  Options: TGIFDrawOptions);
var
  i			: integer;
...
//
////////////////////////////////////////////////////////////////////////////////
// Used by TJvGIFImage to optimize local color maps to a single global color map.
...
type
  ...
  public
    constructor Create(AImage: TJvGIFImage);
    destructor Destroy; override;
    procedure Optimize;
  end;
...
constructor TColorMapOptimizer.Create(AImage: TJvGIFImage);
begin
  inherited Create;
  FImage := AImage;
...
function TJvGIFImage.GetVersion: TGIFVersion;
var
  v			: TGIFVersion;
  i			: integer;
begin
...
function TJvGIFImage.GetColorResolution: integer;
var
  i			: integer;
begin
...
function TJvGIFImage.GetBitsPerPixel: integer;
var
  i			: integer;
begin
...
function TJvGIFImage.GetBackgroundColorIndex: BYTE;
begin
  Result := FHeader.BackgroundColorIndex;
end;

procedure TJvGIFImage.SetBackgroundColorIndex(const Value: BYTE);
begin
...
procedure TJvGIFImage.SetBackgroundColor(const Value: TColor);
begin
  FHeader.BackgroundColor := Value;
end;

function TJvGIFImage.GetAspectRatio: BYTE;
begin
  Result := FHeader.AspectRatio;
end;

procedure TJvGIFImage.SetAspectRatio(const Value: BYTE);
begin
  FHeader.AspectRatio := Value;
end;

procedure TJvGIFImage.SetDrawOptions(Value: TGIFDrawOptions);
begin
...
function TJvGIFImage.GetAnimate: Boolean;
begin  // 2002.07.07
  Result:= goAnimate in DrawOptions;
end;

procedure TJvGIFImage.SetAnimate(const Value: Boolean);
begin  // 2002.07.07
  if Value then
...
procedure TJvGIFImage.SetForceFrame(const Value: Integer);
begin  // 2004.03.09
  FForceFrame := Value;
  Changed(Self);
end;

procedure TJvGIFImage.SetAnimationSpeed(Value: integer);
begin
  if (Value < 0) then
    Value := 0
  else if (Value > 1000) then
...
procedure TJvGIFImage.SetReductionBits(Value: integer);
begin
...
procedure TJvGIFImage.OptimizeColorMap;
var
...
procedure TJvGIFImage.Optimize(Options: TGIFOptimizeOptions;
  ColorReduction: TColorReduction; DitherMode: TDitherMode;
  ReductionBits: integer);
var
  i			,
...
// 2006.07.09 ->
{$IFDEF FIXHEADER_WIDTHHEIGHT_SILENT}
procedure TJvGIFImage.FixHeaderWidthHeight;
var
  i, w, h: Integer;
begin
  for i := 0 to Images.Count - 1 do
...
function TJvGIFImage.NewBitmap: TBitmap;
begin
  Result := FBitmap;
  if (Result <> nil) then
    exit;
...
procedure TJvGIFImage.FreeBitmap;
begin
  if (DrawPainter <> nil) then
    DrawPainter.Stop;
...
function TJvGIFImage.Add(Source: TPersistent): integer;
var
  Image			: TGIFSubImage;
begin
  ...
  begin
    ...
    try
      ...
      // TJvGIFImage does not take ownership of Source after TJvGIFImage.Add() and
...
function TJvGIFImage.GetIsTransparent: Boolean;
var
  i			: integer;
begin
  Result := False;
...
begin
  // Check for recursion
  // (TJvGIFImage.GetPalette->TGIFSubImage.GetPalette->TJvGIFImage.GetPalette etc...)
...
procedure TJvGIFImage.SetPalette(Value: HPalette);
var
  NeedNewBitmap		: boolean;
begin
...
// Obsolete
// procedure TJvGIFImage.Changed(Sender: TObject);
// begin
...
{ TODO 1 -oanme -cImprovement : Better handling of TJvGIFImage.Assign(Empty TBitmap). }
...
begin
  ...
  begin
    ...
    OnProgress := TJvGIFImage(Source).OnProgress;
    try
      FOnWarning := TJvGIFImage(Source).OnWarning;
      Progress(Self, psStarting, 0, False, Rect(0,0,0,0), sProgressCopying);
      try
        FHeader.Assign(TJvGIFImage(Source).Header);
        FThreadPriority := TJvGIFImage(Source).ThreadPriority;
        FDrawBackgroundColor := TJvGIFImage(Source).DrawBackgroundColor;
        FDrawOptions := TJvGIFImage(Source).DrawOptions;
        FColorReduction := TJvGIFImage(Source).ColorReduction;
        FDitherMode := TJvGIFImage(Source).DitherMode;
        FForceFrame := TJvGIFImage(Source).ForceFrame;  // 2004.03.09
// 2002.07.07 ->
        FOnWarning:= TJvGIFImage(Source).FOnWarning;
        FOnStartPaint:= TJvGIFImage(Source).FOnStartPaint;
        FOnPaint:= TJvGIFImage(Source).FOnPaint;
        FOnEndPaint:= TJvGIFImage(Source).FOnEndPaint;
        FOnAfterPaint:= TJvGIFImage(Source).FOnAfterPaint;
        FOnLoop:= TJvGIFImage(Source).FOnLoop;
// 2002.07.07 <-
        for i := 0 to TJvGIFImage(Source).Images.Count-1 do
        begin
          Image := TGIFSubImage.Create(self);
          Image.Assign(TJvGIFImage(Source).Images[i]);
          Add(Image);
          Progress(Self, psRunning, MulDiv((i+1), 100, TJvGIFImage(Source).Images.Count),
...
function TJvGIFImage.GetColorMap: TGIFColorMap;
begin
  Result := FHeader.ColorMap;
end;

function TJvGIFImage.GetDoDither: boolean;
begin
...
procedure TJvGIFImage.StopDraw;
...
procedure TJvGIFImage.Draw(ACanvas: TCanvas; const Rect: TRect);
var
  Canvas		: TCanvas;
  DestRect		: TRect;
{$IFNDEF VER14_PLUS}  // 2001.07.23
...
begin
  ...
  try
    ...
    if (FImages.Count = 1) or // Only one image
      (not (goAnimate in FDrawOptions)) then // Don't JvxAnimate
    begin
      // 2004.03.09 ->
...
function TJvGIFImage.InternalPaint(Painter: PGifPainter; ACanvas: TCanvas;
...
function TJvGIFImage.Paint(ACanvas: TCanvas; const Rect: TRect;
...
procedure TJvGIFImage.PaintStart;
var
  i			: integer;
begin
  with FPainters.LockList do
...
procedure TJvGIFImage.PaintStop;
var
  Ghosts		: integer;
  i			: integer;
{$IFNDEF VER14_PLUS}  // 2001.07.23
...
procedure TJvGIFImage.PaintPause;
var
  i			: integer;
begin
  with FPainters.LockList do
...
procedure TJvGIFImage.PaintResume;
var
  i			: integer;
begin
...
procedure TJvGIFImage.PaintRestart;
var
  i			: integer;
begin
  with FPainters.LockList do
...
procedure TJvGIFImage.Warning(Sender: TObject; Severity: TGIFSeverity; Message: string);
begin
...
initialization
{$IFDEF REGISTER_TGIFIMAGE}
  TPicture.RegisterFileFormat('GIF', sGIFImageFile, TJvGIFImage);
// 2008.10.19 ->
{$IFDEF VER20_PLUS}
