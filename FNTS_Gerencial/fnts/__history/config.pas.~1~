...
uses
  ...
  ACBrMail, dxCore, dxColorEdit, dxDBColorEdit;
...
begin
  if application.messagebox('Esta operação limpa o Banco de Dados e Transfere dados de outros sistemas! Deseja continuar?', 'Atenção', mb_yesno + MB_ICONWARNING + MB_DEFBUTTON2) = idyes then begin
