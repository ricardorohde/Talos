...
uses
  ...
  TFlatPanelUnit, Menus, DBGrids, DBCtrls, AdvGlowButton,
  PageView, AdvShapeButton, AdvMetroButton, AdvSmoothPanel,
  AdvSmoothExpanderPanel, JvMemoryDataset;
...
procedure TfrmPrevenda.AdvMetroButton1Click(Sender: TObject);
begin
  Close;
end;
