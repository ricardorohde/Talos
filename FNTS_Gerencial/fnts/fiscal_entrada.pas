...
uses
  ...
  Dialogs, StdCtrls, Mask, JvToolEdit, ExtCtrls, DB, Wwdatsrc, JvLookup,
  ...
  RzCmboBx, RzDBChk, RzDBCmbo, JvMemDS, CellEditors, JvCurrEdit, XPMenu,
...
type
  Tfrmfiscal_entrada = class(TForm)
    ...
    edqde: TJvValidateEdit;
    edvalor: TJvValidateEdit;
    btincuir: TBitBtn;
    btcancela: TBitBtn;
    edaicms: TJvValidateEdit;
    edsubtotal: TJvValidateEdit;
    edproduto: TRzEdit;
    edst: TRzEdit;
    edaisentasicms: TJvValidateEdit;
    edaoutrasicms: TJvValidateEdit;
    ednotacancelada: TRzComboBox;
    edaisentasipi: TJvValidateEdit;
    edaoutrasipi: TJvValidateEdit;
    PageView5: TPageView;
    ...
    edaipi: TJvValidateEdit;
    edabaseicms: TJvValidateEdit;
    edabaseipi: TJvValidateEdit;
    edunidade: TRzEdit;
    ...
    Label77: TLabel;
    Label78: TLabel;
    tbasecalculo: TJvValidateEdit;
    tvaloricms: TJvValidateEdit;
    tbaseicmssubst: TJvValidateEdit;
    tvaloricmssubst: TJvValidateEdit;
    tvalorproduto: TJvValidateEdit;
    tfrete: TJvValidateEdit;
    tseguro: TJvValidateEdit;
    tdespesas: TJvValidateEdit;
    tipi: TJvValidateEdit;
    tnota: TJvValidateEdit;
    picms: TFlatPanel;
    Label30: TLabel;
    ...
    edserie: TRzEdit;
    ednfiscal: TRzEdit;
    eddtlancamento: TJvDateEdit;
    eddtdocumento: TJvDateEdit;
    edhistorico: TRzEdit;
    ...
    edtie: TRzEdit;
    edtnumero: TRzEdit;
    edtbruto: TJvValidateEdit;
    edtliquido: TJvValidateEdit;
    edtqde: TJvValidateEdit;
    ...
    edpcontas: TRzEdit;
    RDESCONTO_NOTA: TJvValidateEdit;
    comboreducao: TJvValidateEdit;
    ...
    Label41: TLabel;
    Label42: TLabel;
    RICMS_RETIDO: TJvValidateEdit;
    RRETIDO: TJvValidateEdit;
