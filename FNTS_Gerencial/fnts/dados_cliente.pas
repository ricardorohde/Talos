...
type
  Tfrmdados_cliente = class(TForm)
    ...
    procedure bt005_fech558Click(Sender: TObject);
  private
...
procedure Tfrmdados_cliente.AdvMetroButton1Click(Sender: TObject);
begin
  close;
end;
...
procedure Tfrmdados_cliente.bt005_fech558Click(Sender: TObject);
begin
  frmprevenda_impressao := tfrmprevenda_impressao.create(self);
  frmprevenda_impressao.showmodal;
end;
