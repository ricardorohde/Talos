...
begin
  ...
  FXvenda.LoadFromFile('C:\TALOS\server\rel\f000110.fr3');
  FXvenda.ShowReport;
end;
...
begin
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('linha6').asstring := IntToStr(frmvenda.qrvenda_produto.RecordCount);
    frmmodulo.qrrelatorio.post;
    FXvenda.LoadFromFile('C:\TALOS\server\rel\f000048.fr3');
    FXvenda.ShowReport;
    FXvenda.LoadFromFile('C:\TALOS\server\rel\f000049.fr3');
    FXvenda.ShowReport;
  end
  else
  begin
...
begin
  ...
  begin
    ...
    FXvenda.LoadFromFile('C:\TALOS\server\rel\f000049.fr3');
    FXvenda.ShowReport;
    FXvenda.LoadFromFile('C:\TALOS\server\rel\f000081.fr3');
    FXvenda.ShowReport;
...
begin
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('linha6').asstring := IntToStr(frmvenda.qrvenda_produto.RecordCount);
    frmmodulo.qrrelatorio.post;
    FXvenda.LoadFromFile('C:\TALOS\server\rel\f000048_1.fr3');
    FXvenda.ShowReport;
    FXvenda.LoadFromFile('C:\TALOS\server\rel\f000049.fr3');
    FXvenda.ShowReport;
...
begin
  ...
  frmmodulo.qrrelatorio.fieldbyname('linha6').asstring := IntToStr(frmvenda.qrvenda_produto.RecordCount);
  frmmodulo.qrrelatorio.post;
  FXvenda.LoadFromFile('C:\TALOS\server\rel\f000154.fr3');
  FXvenda.ShowReport;
  if QRCONTASRECEBER.RECORDCOUNT > 0 then
  begin
...
begin
  ...
  frmmodulo.qrrelatorio.post;
  FXvenda.LoadFromFile('C:\TALOS\server\rel\f000155.fr3');
  fxvenda.ShowReport;
end;
