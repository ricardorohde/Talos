...
begin
  ...
  if string.Equals(ecliente.Text,EmptyStr) then
  begin
    chkClienteCadastrado.Checked := false;
    //chkClienteCadastradoClick(Sender);
    enomecliente.SetFocus;
  end
  else
  begin
  ecliente.SetFocus;
  chkClienteCadastrado.Checked := True;
  end;
end;
