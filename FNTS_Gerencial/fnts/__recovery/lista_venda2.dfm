object frmlista_venda2: Tfrmlista_venda2
  ...
  object fxvenda: TfrxReport
    ...
    ReportOptions.LastChange = 43371.438441365740000000
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 740.409927000000000000
        Condition = 'fsvenda_produto2."CODNOTA"'
        OutlineText = 'fsvenda_produto2."CODNOTA"'
        object Memo3: TfrxMemoView
          Left = 358.141930000000000000
        ...
        object Memo13: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsvenda_produto2."VENDEDOR"]')
          ParentFont = False
        end
        object Memo19: TfrxMemoView
          Left = 250.299320000000000000
          Top = 1.133858269999990000
      ...
      object GroupFooter1: TfrxGroupFooter
        ...
        object Memo39: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[SUM(<fsvenda_produto2."QTDE">*<fsvenda_produto2."UNITARIO">,Mas' +
              'terData1)]')
          ParentFont = False
        end
        ...
        object Memo43: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<fsvenda_produto2."ACRESCIMO">,MasterData1)]')
          ParentFont = False
        end
  ...
  object qrProdutividade: TZQuery
    Connection = frmmodulo.Conexao
    Active = True
    SQL.Strings = (
      
        'select vendas.codcaixa, usuarios.nome, vendas.data, sum(vendas.t' +
        'otal) as "Total de Vendas", count(vendas.numero_cupom_fiscal) as' +
        ' "Clientes"'
      'from c000048 vendas, c000008 usuarios'
      'join c000045 as caixas on vendas.codcaixa = caixas.codigo'
      'group by data, codcaixa, nome'
      'order by data;')
    Params = <>
    Left = 495
    Top = 288
    object qrProdutividadeCODCAIXA: TWideStringField
      FieldName = 'CODCAIXA'
      Size = 6
    end
    object qrProdutividadeDATA: TDateField
      FieldName = 'DATA'
    end
    object qrProdutividadeTotaldeVendas: TFloatField
      FieldName = 'Total de Vendas'
      ReadOnly = True
    end
    object qrProdutividadeClientes: TIntegerField
      FieldName = 'Clientes'
      ReadOnly = True
    end
    object qrProdutividadeNOME: TWideStringField
      FieldName = 'NOME'
      Size = 80
    end
  end
  object fsProdutividade: TfrxDBDataset
    UserName = 'fsProdutividade'
    CloseDataSource = False
    FieldAliases.Strings = (
      'CODCAIXA=CODCAIXA'
      'DATA=DATA'
      ...
      'Clientes=Clientes'
      'NOME=NOME')
    DataSet = qrProdutividade
    BCDToCurrency = False
    Left = 495
    Top = 248
  end
  object fxProdutividade: TfrxReport
    Version = '5.2.3'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 39181.615094942100000000
    ReportOptions.LastChange = 43471.985824768500000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'begin'
    ...
    Datasets = <
      item
        DataSet = fsProdutividade
        DataSetName = 'fsProdutividade'
      end
      item
        DataSet = fsvenda
        DataSetName = 'fsvenda'
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 740.409927000000000000
        Condition = 'fsProdutividade."DATA"'
        object fsProdutividadeDATA: TfrxMemoView
          Left = 7.559060000000000000
          Width = 79.370130000000000000
          Height = 18.897650000000000000
          DataField = 'DATA'
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'fsProdutividade'
        RowCount = 0
        object fsProdutividadeCODCAIXA: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[fsProdutividade."CODCAIXA"]')
          ParentFont = False
        end
        object fsProdutividadeTotaldeVendas: TfrxMemoView
          ...
          DisplayFormat.Kind = fkNumeric
          Memo.UTF8W = (
            '[fsProdutividade."Total de Vendas"]')
        end
        object fsProdutividadeClientes1: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsProdutividade."Clientes"]')
          ParentFont = False
        end
        object fsProdutividadeNOME: TfrxMemoView
          Left = 132.283550000000000000
          Top = 3.779530000000000000
      ...
      object GroupFooter1: TfrxGroupFooter
        ...
        object fsProdutividadeClientes: TfrxMemoView
          Left = 657.638220000000000000
          Top = 3.779530000000020000
          Width = 79.370130000000000000
          Height = 18.897650000000000000
          ...
          Font.Style = [fsItalic]
          Memo.UTF8W = (
            '[SUM(<fsProdutividade."Clientes">)]')
          ParentFont = False
        end
        object fsProdutividadeTotaldeVendas1: TfrxMemoView
          Left = 207.874150000000000000
          Top = 3.779530000000020000
          Width = 173.858380000000000000
          Height = 18.897650000000000000
          ...
          Font.Style = [fsItalic]
          Memo.UTF8W = (
            '[SUM(<fsProdutividade."Total de Vendas">)]')
          ParentFont = False
        end
      end
    end
  end
  object qrCaixas: TZQuery
    Connection = frmmodulo.Conexao
    SQL.Strings = (
      
        'select caixas.codigo, usuarios.nome from c000045 caixas, c000008' +
        ' usuarios'
      'where caixas.codfuncionario = usuarios.codigo'
      'group by caixas.codigo, usuarios.nome')
    Params = <>
    Left = 416
    Top = 304
    object qrCaixasCODIGO: TWideStringField
      FieldName = 'CODIGO'
      Required = True
      Size = 6
    end
    object qrCaixasNOME: TWideStringField
      FieldName = 'NOME'
      Size = 80
    end
  end
  object fsCaixas: TfrxDBDataset
    UserName = 'fsCaixas'
    CloseDataSource = False
    FieldAliases.Strings = (
      'CODIGO=CODIGO'
