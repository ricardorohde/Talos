...
uses
  ...
  ZDataset, RzCmboBx, RzPrgres, wwdbedit, Wwkeycb, Menus,
  frxDesgn, frxClass, frxDBSet, AdvMetroButton, AdvSmoothPanel,
...
begin
  ...
  fXproduto.LoadFromFile('\TALOS\server\rel\f000126.fr3');
