...
{      if ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x].Imposto.ICMS.cst = cstVazio then
      ...
      { : PREÇOS }
      qritemPRECOCUSTO.ASFLOAT := RoundTo((qritemTOTAL.ASFLOAT + qritemFRETE.ASFLOAT + qritemSEGURO.ASFLOAT + qritemOUTRAS.ASFLOAT + qritemIPI_VALOR.ASFLOAT) / (qritemQTDE.ASFLOAT) / qritemFRACAO.ASFLOAT, -2);
