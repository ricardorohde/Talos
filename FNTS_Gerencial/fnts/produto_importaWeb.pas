...
type
  Tfrmproduto_importaWeb = class(TForm)
...
var
  frmproduto_importaWeb: Tfrmproduto_importaWeb;
  voltar: boolean;
...
procedure Tfrmproduto_importaWeb.Localizarpor1Click(Sender: TObject);
var X: INTEGER;
begin
...
procedure Tfrmproduto_importaWeb.Referncia1Click(Sender: TObject);
var X: INTEGER;
begin
...
procedure Tfrmproduto_importaWeb.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  ACTION := CAFREE;
end;

procedure Tfrmproduto_importaWeb.Fechar1Click(Sender: TObject);
begin
...
procedure Tfrmproduto_importaWeb.locKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = vk_down then
  begin
...
procedure Tfrmproduto_importaWeb.locKeyPress(Sender: TObject; var Key: Char);
var ref, tipo: string;
begin
  if key = #13 then
  begin
...
procedure Tfrmproduto_importaWeb.locEnter(Sender: TObject);
begin
  tedit(sender).color := $00A0FAF8;
  voltar := false;
end;

procedure Tfrmproduto_importaWeb.locExit(Sender: TObject);
begin
  tedit(sender).color := clwindow;
end;

procedure Tfrmproduto_importaWeb.FormShow(Sender: TObject);
begin
...
procedure Tfrmproduto_importaWeb.GRIDEnter(Sender: TObject);
begin
...
procedure Tfrmproduto_importaWeb.GRIDExit(Sender: TObject);
begin
  lvoltar.Caption := 'FECHAR';
  VOLTAR := FALSE;
end;

procedure Tfrmproduto_importaWeb.locChange(Sender: TObject);
var ref, tipo: string;
begin
  if combo_referencia.ItemIndex = 0 then ref := '' else ref := '%';
  if COMBO_LOCALIZAR.ITEMINDEX < 3 then
...
procedure Tfrmproduto_importaWeb.wwDBGrid1Enter(Sender: TObject);
begin
  voltar := true;
  lvoltar.Caption := 'VOLTAR';
end;

procedure Tfrmproduto_importaWeb.wwDBGrid1Exit(Sender: TObject);
begin
  lvoltar.Caption := 'FECHAR';
  VOLTAR := FALSE;
end;

procedure Tfrmproduto_importaWeb.wwDBGrid1KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then locKeyPress(frmproduto_importaWeb, key);
  loc.setfocus;
end;

procedure Tfrmproduto_importaWeb.ParmetrosdaPesquisa1Click(Sender: TObject);
begin
  loc.setfocus;
end;

procedure Tfrmproduto_importaWeb.RxCalcEdit2Change(Sender: TObject);
begin
...
procedure Tfrmproduto_importaWeb.GRIDRowChanged(Sender: TObject);
begin
  if QUERY.FIELDBYNAME('foto').ASSTRING <> '' then bfoto.enabled := true else bfoto.enabled := false;
  AdvGlowButton4.Enabled := QUERY.FIELDBYNAME('USA_TB_PC').AsString = 'SIM';
end;

procedure Tfrmproduto_importaWeb.FotodoProduto1Click(Sender: TObject);
begin
  if bfoto.enabled then bfotoclick(frmproduto_importaWeb);
end;

procedure Tfrmproduto_importaWeb.AdvMetroButton1Click(Sender: TObject);
begin
  close;
end;

procedure Tfrmproduto_importaWeb.BFOTOClick(Sender: TObject);
begin
  try
...
procedure Tfrmproduto_importaWeb.ConsultaServio1Click(Sender: TObject);
begin
...
procedure Tfrmproduto_importaWeb.dsStateChange(Sender: TObject);
begin
  AdvGlowButton4.Enabled := False;
end;

procedure Tfrmproduto_importaWeb.AdvGlowButton1Click(Sender: TObject);
begin
  frmxloc_servico := tfrmxloc_servico.create(self);
  frmxloc_servico.showmodal;
  LOC.SETFOCUS;
