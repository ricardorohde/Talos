...
uses
  ...
  Mask, maskutils, AdvGlowButton, dxGDIPlusClasses, cyBaseSpeedButton,
  cySpeedButton, AdvSmoothTouchKeyBoard, AdvMetroButton, AdvSmoothPanel,
...
procedure TfrmCaixa_operador.dscaixa_operador2DataChange(Sender: TObject;
  Field: TField);
begin
  cxDBCheckBox1.Visible := frmmodulo.qrcaixa_operadorCODIGO.AsString <> '000099';
end;
