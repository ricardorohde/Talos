...
uses
  ...
  AdvGlowButton, Vcl.Imaging.jpeg, AdvMetroButton, AdvSmoothPanel,
...
begin
  ...
  if FileExists('\TALOS\server\bd\eDI.inf') then
  begin
    assignfile(txt, '\TALOS\server\bd\eDI.inf');
    reset(txt);
...
begin
  ...
  frminventario.fXproduto.LoadFromFile('\TALOS\server\rel\f000126.fr3');
