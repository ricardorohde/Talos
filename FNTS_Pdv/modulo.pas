...
uses
  ...
  ACBrGAV, ACBrDFeReport, ACBrDFeDANFeReport;
...
var
  ...
  pesquisaCodigoProduto, pesquisaCodBarras, pesquisaNomeProd: Boolean;
...
begin
  ...
  try
    pesquisaCodigoProduto := Ini.ReadBool('Geral', 'PesquisaCodigoProduto', True);
    pesquisaCodBarras := Ini.ReadBool('Geral', 'PesquisaCodigoBarras', True);
    pesquisaNomeProd := Ini.ReadBool('Geral', 'PesquisaNomeProduto', True);
