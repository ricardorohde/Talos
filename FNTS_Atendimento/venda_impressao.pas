...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, jpeg, TFlatPanelUnit, Spin,
...
begin
 ...
 // qrrel.fieldbyname('linha13').asstring := inttostr(trunc((frmvenda_pdv.qrvenda_produto.recordcount/30)+0.99));
  ...
  qrrel.fieldbyname('valor1').asfloat := frmvenda_pdv.cdsvenda_produto.recordcount;
  ...
  FXvenda.LoadFromFile('\TALOS\SERVER\rel\f000160pdv.fr3');
...
begin
     ...
     frmmodulo.qrrelatorio.post;
      ...
      fxVENDA.LoadFromFile('\TALOS\SERVER\rel\f000069PDV.fr3');
      fxVENDA.ShowReport;
end;
