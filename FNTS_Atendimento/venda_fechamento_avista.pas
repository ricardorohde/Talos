...
uses
  ...
  Dialogs, ExtCtrls, StdCtrls, Mask, TFlatComboBoxUnit, Menus, jpeg, TFlatPanelUnit, Buttons,
...
procedure Tfrmvenda_fechamento_avista.AdvGlowButton1Click(Sender: TObject);
begin
  bgravar.Click;
end;

procedure Tfrmvenda_fechamento_avista.AdvGlowButton2Click(Sender: TObject);
begin
  bcancelar.Click;
end;

procedure Tfrmvenda_fechamento_avista.AdvMetroButton1Click(Sender: TObject);
begin
  bcancelar.Click;
end;
