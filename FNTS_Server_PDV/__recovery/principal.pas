                ...
                while not qrPDV3.eof do begin
                  ...
                  qrItem.First;
                    ...
                    if (qritem.FieldByName('USA_GRADE').AsInteger = 1) then begin
                      ...
                      on E:Exception do begin
                        Memo1.Lines.Add('Erro na atualização de grade do produto ao tentar deduzir ' + qrPDV3.FIELDBYNAME('QTDE').AsString + ' unidades do produto ' +
