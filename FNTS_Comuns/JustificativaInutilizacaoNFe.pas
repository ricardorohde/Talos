unit JustificativaInutilizacaoNFe;
...
type
  TfrmJustificativaInutilizacaoNFe = class(TForm)
    Panel2: TPanel;
    Panel3: TPanel;
...
var
  frmJustificativaInutilizacaoNFe: TfrmJustificativaInutilizacaoNFe;
...
procedure TfrmJustificativaInutilizacaoNFe.bcancelarClick(Sender: TObject);
begin
  Continua := False;
  Close;
end;

procedure TfrmJustificativaInutilizacaoNFe.bgravarClick(Sender: TObject);
begin
...
procedure TfrmJustificativaInutilizacaoNFe.edNumeroExit(Sender: TObject);
begin
  edNumero.Text := frmPrincipal.zerarcodigo(edNumero.Text, 6);
end;
