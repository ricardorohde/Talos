object frmDivergenciaAtualizacaoNCM: TfrmDivergenciaAtualizacaoNCM
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'frmDivergenciaAtualizacaoNCM'
  ClientHeight = 405
  ClientWidth = 762
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label53: TLabel
      ...
      Width = 494
      Height = 23
      Caption = 'Produtos com diverg'#234'ncia de NCM ap'#243's atualiza'#231#227'o'
  ...
  object Panel2: TPanel
    ...
    object GRID: TwwDBGrid
      ...
      Height = 295
      ControlType.Strings = (
        'NCM_N;CustomEdit;RzDBButtonEdit1;F')
      Selected.Strings = (
        'codigo'#9'6'#9'Produto'#9#9
        'descricao'#9'57'#9'Descri'#231#227'o'#9#9
        'NCM_A'#9'20'#9'NCM Antigo'#9#9
        'NCM_N'#9'20'#9'NCM_N'#9#9)
  ...
  object dspro: TDataSource
    DataSet = frmAtualizaNCM.cdsProdutos
    Left = 536
    Top = 200
  end
end
